...
class Application extends React.Component {
  render() {
    ...
    const sectionTwoTitle = 'Race information';
    const sectionTwoMessage = ['For more information contact Running Around at 260.248.1218'];
    const tinyMessages = [{
    ...
    return (
      <div className='page-layout'>
        ...
        <Section
          ...
          message={sectionTwoMessage}
          tinyMessages={tinyMessages}
        />
      </div>
    );
  }
